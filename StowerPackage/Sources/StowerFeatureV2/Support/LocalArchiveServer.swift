...
final class LocalArchiveServer: @unchecked Sendable {
    ...
    init(archiveDir: URL, articlePath: String) {
    ...
    func start() async throws -> UInt16 {
        ...
        listener.newConnectionHandler = { [queue] connection in
            Self.handleConnection(connection, archiveDir: archiveDir, articlePath: articlePath, queue: queue)
        }
    ...
    private static func handleConnection(
        ...
        connection.receive(minimumIncompleteLength: 1, maximumLength: 65536) { data, _, _, error in
            ...
            // Determine the local file to serve
            let fileURL: URL
            ...
            guard FileManager.default.fileExists(atPath: fileURL.path),
                ...
                print("[ArchiveServer] 404: \(decodedPath) → \(fileURL.path)")
